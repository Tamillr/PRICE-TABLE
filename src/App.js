  ...
  render() {
    ...
    return (
      <PricingTable highlightColor='#1976D2'>
        ...
        <PricingSlot onClick={this.submit} buttonText={cloudPlans[3].tag} title={cloudPlans[3].plan} priceText={cloudPlans[3].price} >
          <PricingDetail className="text">  {cloudPlans[3].text}</PricingDetail>
          <PricingDetail> &#10003;{cloudPlans[3].storage}</PricingDetail>
          <PricingDetail> &#10003;{cloudPlans[3].dataTransfer}</PricingDetail>
          <PricingDetail >&#10003;{cloudPlans[3].panel} </PricingDetail>
          <PricingDetail >&#10003;{cloudPlans[3].support} </PricingDetail>
          <PricingDetail >&#10003;{cloudPlans[3].themes} </PricingDetail>
          <PricingDetail >&#10003;{cloudPlans[3].others} </PricingDetail>
        </PricingSlot>
